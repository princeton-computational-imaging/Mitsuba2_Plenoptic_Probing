...
class CodedPerspectiveCamera final : public ProjectiveCamera<Float, Spectrum> {
public:
    ...
    CodedPerspectiveCamera(const Properties &props) : Base(props) {
    ...
    std::string to_string() const override {
        ...
        oss << "CodedPerspectiveCamera[" << std::endl
...
MTS_IMPLEMENT_CLASS_VARIANT(CodedPerspectiveCamera, ProjectiveCamera)
MTS_EXPORT_PLUGIN(CodedPerspectiveCamera, "Coded Perspective Camera");
