...
class SpatialProbingVolumetricPathIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
...
public:
    ...
    SpatialProbingVolumetricPathIntegrator(const Properties &props) : Base(props) {
      m_delta = Point2f(
...
MTS_IMPLEMENT_CLASS_VARIANT(SpatialProbingVolumetricPathIntegrator, MonteCarloIntegrator);
MTS_EXPORT_PLUGIN(SpatialProbingVolumetricPathIntegrator, "Volumetric Path Tracer integrator");
