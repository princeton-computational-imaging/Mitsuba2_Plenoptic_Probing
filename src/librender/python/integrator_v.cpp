...
public:
    MTS_IMPORT_TYPES(SamplingIntegrator, Scene, Sampler, Sensor, Medium, Emitter, EmitterPtr, BSDF, BSDFPtr)
    ...
    integrator.def(
        ...
        [](const SamplingIntegrator *integrator, const Scene *scene, Sampler *sampler,
           const RayDifferential3f &ray, const Medium *medium, Mask active) {
            ...
            auto [spec, mask] = integrator->sample(scene, sampler, nullptr, Vector2f(0), ray, medium, aovs.data(), active);
