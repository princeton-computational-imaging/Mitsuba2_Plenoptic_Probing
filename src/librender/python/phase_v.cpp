...
public:
    ...
    Spectrum polarization(const PhaseFunctionContext &ctx, const Spectrum inc,
                          const MediumInteraction3f & mi,
                          const Vector3f wo, Mask active) const override {
        PYBIND11_OVERLOAD(Spectrum, PhaseFunction, polarization, ctx, inc, mi, wo, active);
    }
...
MTS_PY_EXPORT(PhaseFunction) {
    ...
    auto phase = py::class_<PhaseFunction, PyPhaseFunction, Object, ref<PhaseFunction>>(
                        ...
                        .def("polarization", vectorize(&PhaseFunction::polarization),
                             "ctx"_a, "incoming"_a, "mi"_a, "wo"_a, "active"_a = true,
