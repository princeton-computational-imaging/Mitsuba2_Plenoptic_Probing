...
public:
    ...
    /**
     * \brief Computes polarization of outgoing light
     * Computes polarization of outgoing light according to some partical interaction scheme.
     * Defaults to just returning the spectrum of the incoming light
     * \return The polarized outgoing light
     */
    virtual Spectrum polarization(const PhaseFunctionContext & /*ctx*/, const Spectrum incoming,
...
ENOKI_CALL_SUPPORT_TEMPLATE_BEGIN(mitsuba::PhaseFunction)
    ...
    ENOKI_CALL_SUPPORT_METHOD(polarization)
